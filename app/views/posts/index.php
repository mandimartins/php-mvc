...
<div class="row">
    ...
    <div class="col-md-6 d-flex justify-content-end align-items-center">
        <a href="<?php echo APPROOT; ?>/posts/add" class="btn btn-primary">
        <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0
             .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1
              ...
              3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528
    ...
    <div class="row mb-3">
      ...
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <div class="mb-1 text-muted">Written by: <strong class="text-dark"><?php echo $post->name; ?></strong></div>
          <p class="mb-auto">This is a wider card with supporting text below as a natural lead-in to additional content.</p>
          <a href="<?php echo APPROOT; ?>/posts/show/" class="stretched-link">Continue reading</a>
        </div>
